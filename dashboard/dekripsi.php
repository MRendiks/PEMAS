    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          <h1 class="h4 mb-0 ml-2 text-gray-800">Dekripsi - Pengaduan Masyarakat Melalui Citra Bitmap</h1>
        ...
        <div class="container-fluid">
          <div class="alert alert-success" role="alert">
            ...
            Pengaduan Masyarakat Melalui Citra Bitmap - Dekripsi
          </div>
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Form Dekripsi - File Kependudukan</h6>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <table class="table table-bordered" id="file" width="100%" cellspacing="0">
                    ...
                    <tbody>
                      <?php
                      $i = 1;
                      $query = $mysqli->query("SELECT * FROM enkripsi");
                      while ($data = mysqli_fetch_array($query)) { ?>
                        <tr>
                          <td><?php echo $i; ?></td>
                          <td><?php echo $data['nama_file']; ?></td>
                          <td><?php echo $data['nama_file_enkripsi']; ?></td>
                          <!-- <td><?php echo $data['letak file enkr']; ?></td> -->
                          ...
                          <td>
                            <?php
                            $a = $data['id_enkripsi'];
                            echo '<a href="dekripsi-file.php?id_enkripsi=' . $a . '" class="btn btn-warning"><i class="fas fa-fw fa-lock-open mr-2"></i>Dekripsi</a>';
                            ?>
                            <?php
                            $a = $data['id_enkripsi'];
