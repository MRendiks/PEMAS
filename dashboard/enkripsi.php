...
<head>
  ...
  <title>Enkripsi - Pengaduan Masyarakat Melalui Citra Bitmap</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          <h1 class="h4 mb-0 ml-2 text-gray-800">Enkripsi - Pengaduan Masyarakat Melalui Citra Bitmap</h1>
        ...
        <div class="container-fluid">
          <div class="alert alert-success" role="alert">
            ...
            Pengaduan Masyarakat Melalui Citra Bitmap - Form Enkripsi
          </div>
          <div class="row">
            <div class="col-md-6">
                ...
                <div class="card-body">
                  <form class="form-horizontal" method="post" action="enkripsi-proses.php" enctype="multipart/form-data">
                    <fieldset>
                      ...
                      <div class="form-group">
                        <label class="col-lg-12 control-label" for="inputFile">Gambar</label>
                        <div class="col-lg-12">
                      ...
                      <div class="form-group">
                        <label class="col-lg-12 control-label" for="textArea">Pesan</label>
                        <div class="col-lg-12">
                          <textarea class="form-control" id="textArea" rows="3" name="pesan" placeholder="Deskripsi"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
          ...
          <footer class="sticky-footer bg-white">
            <div class="container my-auto">
              <div class="copyright text-center my-auto">
                <span>Copyright &copy; Pengaduan Masyarakat Melalui Citra Bitmap</span>
              </div>
            </div>
          </footer>
          <!-- End of Footer -->
