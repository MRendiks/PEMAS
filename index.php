...
<head>
  ...
  <title>
    Pengaduan Masyarakat Melalui Citra Bitmap
  </title>
              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-1">Login Pengaduan<br>Masyarakat dengan melalui<br>Citra Bitmap</h1>
                    <img src="img/pemas_logo.png" class="mt-2 mb-4" width="100">
                  </div>
                  ...
                  <br>
                    <a class="small btn btn-success btn-user btn-block" style="text-decoration: none;" href="register.php">Registrasi</a>
                  <br><hr><br>
